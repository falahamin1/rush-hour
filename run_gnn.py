...
def train_graph_rep(board_str=None, episodes=1000, checkpoint_path=None, on_checkpoint=None):
    ...
    if ckpt is not None:
        ...
        print(f"[GNN] Resumed from checkpoint at ep={start_ep}  best={best_moving_avg:.2f}")
