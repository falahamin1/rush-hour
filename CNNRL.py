"""
CNN actor-critic for Rush Hour — the "encoder every reviewer will imagine".

The 6x6 board is encoded as a multi-channel occupancy image (occupancy,
target-vehicle, orientation channels) and pushed through a small CNN.
This gives the encoder local geometric structure (unlike the flat MLP) but
still no permutation-invariance over vehicles — it reasons over grid cells,
not over a set of pieces.
"""
import torch.nn as nn

from rush_hour_env import GRID
